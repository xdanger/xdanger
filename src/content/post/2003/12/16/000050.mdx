...
2. Google 是上市公司，不是网络组织，Google 在全世界任何地方都不曾使用 .net 的域名（可能会抢注，但是都是转域名的，比如 [http://google.net](http://google.net)）。在 Google 最新工具栏里所列出的全部 85 个地区域名中没有一个 .net，都是 *.com.地区* 或者 *.co.地区* 或者干脆 *.地区*。难道在中国列外？
...
3. Google 不会委屈在他人的服务器下，做一个虚拟主机的使用者。试试看
   ...
   *Update on 2003-12-08 14:50: 应 google.net.cn 作者的合理要求，删去相应截图。*
...
5. 域名注册非常可疑。*Update on 2003-12-08 15:35: 应 google.net.cn 作者的合理要求，删去了域名注册记录相关文字。* 而正宗 Google 的域名注册信息应该是这样的：[http://218.30.103.79/cgi-bin/Whois.cgi?domain=google&com=yes&work=whois&big5=n](http://218.30.103.79/cgi-bin/Whois.cgi?domain=google&com=yes&work=whois&big5=n)
...
7. 随便输入一个关键字搜索，第一次总是使用较多的时间，而显示的搜索时间是 *0.XX* 秒。试试看刷新一下页面？哈哈，又是大破绽，***搜索用时*** 一直不变的！看来还是经过精心策划的，怕以后访问量太大服务器不堪重负，已经设计好搜索缓存。
