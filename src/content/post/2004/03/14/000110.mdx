...
tags: ["assembly", "mcs-51", "8086", "programming", "microcontroller", "embedded systems", "counter", "display", "tech", "academic"]
description: "作者分享了一个为期一周完成的 MCS-51(8086) 汇编程序作业。该程序实现了一个简单的数字计数器系统，通过八个按钮分别控制千、百、十、个位的增减，带进位功能，并在七段数码管上显示四位数字，初始值为 0000。文章包含了完整的汇编源代码，实现了按键识别、数字变更和显示功能。"
publishDate: "2004-03-14 03:00:32"
---
