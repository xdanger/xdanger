...
category: "Tech"
tags: []
description: "昨天说到已经将我的主页改为PmWiki的构架，刚才忙活了一晚上，终于全部搞定了，于是写下来。 PmWiki简介：PmWiki是一个不需要数据库的以PHP为主要语言编写的wiki，遵循General Public License (GPL)协议，小巧方便，很适合个人网站用来制作规模不大的互动资源平台。 我的安装平台：Wi..."
