...
description: "本文记录了作者成为 Ning 开发者的经历和初步体验。Ning 是一个社会性应用的开发平台，提供了完整的框架和 API，让开发者可以快速创建项目。平台上已有众多模仿 Craigslist、Flickr、del.icio.us 等知名应用的项目，所有开发者都可以查看这些项目的源代码，并进行克隆和修改。作者认为这种模式有助于快速发现好的创意并让它们得到发展，虽然尚不明确 Ning 的商业模式，但其封闭的框架确保了优质项目能首先被 Ning 投入实际运营。"
